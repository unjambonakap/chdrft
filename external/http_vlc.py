# https://raw.githubusercontent.com/MatejMecka/python-vlc-http/master/python_vlc_http/vlc.py
import logging
import requests
...
class HttpVLC:
  ...
  def status_code(self, request):
    if request.status_code == 200:
      ...
      raise RequestFailed(
          f"Query failed, response code: {request.status_code} Full message: {request.text}"
      )

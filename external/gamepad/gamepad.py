...
class Gamepad:
  ...
  def __init__(self, joystickNumber=0):
    ...
    self.connected = True
    self.pressedEventMap = defaultdict(list)
    self.releasedEventMap = defaultdict(list)
    self.changedEventMap = defaultdict(list)
    self.movedEventMap = defaultdict(list)
  ...
  def removeAllEventHandlers(self):
    ...
    for index in self.pressedEventMap.keys():
      self.pressedEventMap[index].clear()
      self.releasedEventMap[index].clear()
      self.changedEventMap[index].clear()
      self.movedEventMap[index].clear()
